...
function Supply() {
    ...
    return (
        <div>
            ...
            <form onSubmit={handlerSubmitRMSsupply} className='flex gap-3 justify-center items-center'>
                ...
                <button className="btn btn-outline-success btn-sm my-3 shadow" onSubmit={handlerSubmitRMSsupply}>Supply</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 2: Manufacture</b>(Only a registered Manufacturer can perform this step):-</h5>
            <form onSubmit={handlerSubmitManufacturing} className='flex gap-3 justify-center items-center'>
                <input className="form-control-sm border-solid border-2 shadow" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm my-3 shadow" onSubmit={handlerSubmitManufacturing}>Manufacture</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 3: Distribute</b>(Only a registered Distributor can perform this step):-</h5>
            <form onSubmit={handlerSubmitDistribute} className='flex gap-3 justify-center items-center'>
                <input className="form-control-sm border-solid border-2 shadow" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm my-3 shadow" onSubmit={handlerSubmitDistribute}>Distribute</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 4: Retail</b>(Only a registered Retailer can perform this step):-</h5>
            <form onSubmit={handlerSubmitRetail} className='flex gap-3 justify-center items-center'>
                <input className="form-control-sm border-solid border-2 shadow" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm my-3 shadow" onSubmit={handlerSubmitRetail}>Retail</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 5: Mark as sold</b>(Only a registered Retailer can perform this step):-</h5>
            <form onSubmit={handlerSubmitSold} className='flex gap-3 justify-center items-center'>
                <input className="form-control-sm border-solid border-2 shadow" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm my-3 shadow" onSubmit={handlerSubmitSold}>Sold</button>
            </form>
            <hr />
        </div>
    )
